...
#define AUTH "9eEoDa41ZRPgg62XetVQsBSuPCpwJRx2"                 // You should get Auth Token in the Blynk App.  
#define WIFI_SSID "RORONOAZORO-2.4G"             //Enter Wifi Name
#define WIFI_PASS "danish9315"         //Enter wifi Password
